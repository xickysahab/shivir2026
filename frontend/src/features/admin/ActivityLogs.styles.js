const styles = {
  ...
  th: { padding: '16px', borderBottom: '1px solid rgba(255,255,255,0.1)', fontWeight: 600, color: '#a78bfa', position: 'sticky', top: 0, background: 'rgba(30,30,47,0.95)', backdropFilter: 'blur(10px)', fontSize: '13px', textTransform: 'uppercase', letterSpacing: '0.5px', zIndex: 5 },
  ...
  userRole: { color: 'rgba(255,255,255,0.4)', fontSize: '10px', textTransform: 'uppercase' },
  badge: { padding: '3px 8px', borderRadius: '6px', fontSize: '10px', fontWeight: 'bold' },
