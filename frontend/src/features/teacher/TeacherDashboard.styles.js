const styles = {
  ...
  roleBadge: { fontSize: '11px', fontWeight: 700, color: '#818cf8', textTransform: 'uppercase', letterSpacing: '0.05em', background: 'rgba(99, 102, 241, 0.12)', padding: '4px 10px', borderRadius: '12px' },
  ...
  userAvatar: {
    width: '36px', height: '36px', borderRadius: '10px', background: 'rgba(99,102,241,0.2)', color: '#818cf8', display: 'flex', alignItems: 'center', justifyContent: 'center', fontWeight: 'bold'
  },
  userName: {
  ...
  bottomNav: {
    ...
    padding: '12px 10px calc(env(safe-area-inset-bottom, 12px) + 12px) 10px',
    zIndex: 100,
